...
const HYPERBOLIC_SHADER: &str = include_str!("../compute_shaders/i8/hyperbolic.wgsl");

const TRIGONOMETRY_SHADER: &str = include_str!("../compute_shaders/i8/trigonometry.wgsl");
